...
class Product_Parent_Kits extends Wizshop_Widget_Base {

	public function get_name() {
		return 'wizshop-product-kit-contains';
	}

	public function get_title() {
		return __( 'Parent Kits', 'wizshop-for-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'wizshop', 'shop', 'store', 'kit', 'product' ];
	}
	...
	protected function wizshop_render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wizshop-product-kit-contains' );

		?><div class="wiz-table wiz-table-responsive" style="width: 100%;" data-wiz-parent-kits>
	...
	protected function _wizshop_content_template() {
		?><div class="wiz-table wiz-table-responsive" data-wiz-parent-kits>
        <div class="wiz-table-head">
            <div class="wiz-table-row">
