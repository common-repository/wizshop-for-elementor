...
class Product_Related_Products extends Wizshop_Widget_Base {

	public function get_name() {
		return 'wizshop-product-related-products';
	}

	public function get_title() {
		return __( 'Product Related Products', 'wizshop-for-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'wizshop', 'shop', 'store', 'related', 'product' ];
	}
	...
	protected function wizshop_render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wizshop-product-related-products' );

		?><div class="wiz-table wiz-table-responsive" style="width: 100%;" data-wiz-comp-item-container>
			...
			<div class="wiz-table-body">
                <div class="wiz-table-item" data-wiz-comp-item>
	                    ...
	                    <?php if($settings['show_product_qty'] == 'yes') { ?><div class="wiz-table-cell"><span class="table-cell-mobile-title"><?php echo $settings['product_qty_label']; ?></span>
                            <span class="table-cell-content">
                                <span class=" {{dispCart}} {{dispUnits}} {{dispPacks}}single">
                                    <input type="number" class="input-text qty text"  min="0" size="2" wiz_QuantId="{{QuantId}}" data-wiz-packs-only="{{OnlyPacks}}" value="1">
                                </span>

                                <span class="{{dispCart}} {{dispPacks}}">
                                    <input type="number" class="input-text qty text" min="0" size="2" wiz_PacksId="{{PacksId}}" data-wiz-quant-in-pack="{{QntInPack}}" value="1">
                                </span>
                            </span>
                        </div><?php } ?>
	...
	protected function _wizshop_content_template() {
		?><div class="wiz-table wiz-table-responsive" data-wiz-comp-item-container>
			<div class="wiz-table-head">
                <div class="wiz-table-row">
