...
class Product_Qty extends Wizshop_Widget_Base {

	public function get_name() {
		return 'wizshop-product-qty';
	}

	public function get_title() {
		return __( 'Product Quantity', 'wizshop-for-elementor' );
	}
	...
	protected function wizshop_render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wizshop-product-qty' );
