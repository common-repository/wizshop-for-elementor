...
class Product_Add_To_Cart extends Wizshop_Widget_Base {

	public function get_name() {
		return 'wizshop-product-add-to-cart';
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name' => 'atc_typography',
				'selector' => '{{WRAPPER}} .wizshop-product-add-to-cart',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wizshop-product-add-to-cart' => 'color: {{VALUE}};',
				],
				'default' => '#ffffff',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wizshop-product-add-to-cart' => 'background-color: {{VALUE}};',
				],
                'default' => '#61ce70',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wizshop-product-add-to-cart' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .wizshop-product-add-to-cart' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .wizshop-product-add-to-cart' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
	...
	protected function wizshop_render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wizshop-product-add-to-cart' );

		?><div class="{{dispCart}}">
            <a class="wizshop-product-add-to-cart elementor-button" style="display: inline-block;" href="javascript:void(0);"
                 data-wiz-item-to-cart="{{ItemKey}}"
                 data-wiz-packs-ctrl="{{PacksId}}"
                 data-wiz-quant-ctrl="{{QuantId}}"
                 data-wiz-check-quant="1"
                 data-wiz-remark-ctrl="{{RemarkId}}"
                 data-wiz-item-row data-wiz-item-col data-wiz-status * ><?php echo $settings['add_to_cart']; ?>
            </a>
            <a href="<?php echo esc_url(wizshop_get_cart_url()); ?>" data-wiz-view-list='{{urlItemKey}}' class="v_ihide"><?php _e('הצגת רשימה', 'wizshop-for-elementor'); ?></a>
        </div><?php
	}
